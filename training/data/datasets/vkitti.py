...
def _require_cv2():
    ...
    if cv2 is None:
        try:
            ...
            raise ImportError("OpenCV is required to load VKitti images and depths.") from exc
    return cv2
...
class VKittiDataset(BaseDataset):
    ...
    def get_data(
        ...
        for image_idx in ids:
            ...
            depth_map = cv2_mod.imread(depth_filepath, cv2_mod.IMREAD_ANYCOLOR | cv2_mod.IMREAD_ANYDEPTH)
